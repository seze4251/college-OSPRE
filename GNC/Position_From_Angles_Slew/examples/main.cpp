...
#include "main.h"
#include "Position_From_Angles_Slew_terminate.h"
#include "Position_From_Angles_Slew_initialize.h"
...
static void main_Position_From_Angles_Slew()
{
  ...
  Position_From_Angles_Slew(dv0, dv1, dv2, argInit_real_T(), argInit_real_T(),
    dv3, argInit_real_T(), r_E_SC1, r_E_SC2);
}
...
int main(int, const char * const [])
{
  ...
  Position_From_Angles_Slew_initialize();
  ...
  // You do not need to do this more than one time.
  Position_From_Angles_Slew_terminate();
  return 0;
}

...
static void c_emlrt_marshallOut(const real_T u[36], const mxArray *y);
...
static real_T (*emlrt_marshallIn(const emlrtStack *sp, const mxArray *x_hat,
  ...
  static const mxArray *d_emlrt_marshallOut(const real_T u[3])
{
  ...
  emlrtSetDimensions((mxArray *)m1, *(int32_T (*)[1])&iv5[0], 1);
  emlrtAssign(&y, m1);
  return y;
}
  ...
  static const mxArray *e_emlrt_marshallOut(const real_T u[3])
{
  ...
  emlrtSetDimensions((mxArray *)m2, *(int32_T (*)[2])&iv7[0], 2);
  emlrtAssign(&y, m2);
  return y;
}
  ...
  const char_T *identifier))[6]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = b_emlrt_marshallIn(sp, emlrtAlias(x_hat), &thisId);
...
void Kalman_Filter_Iteration_api(const mxArray *prhs[6], const mxArray *plhs[3])
{
  ...
  x_hat = emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "x_hat");
  ...
  b_emlrt_marshallOut(*x_hat, prhs[0]);
  plhs[1] = prhs[0];
  c_emlrt_marshallOut(*P, prhs[2]);
  plhs[2] = prhs[2];
}
...
void Position_From_Angles_Slew_api(const mxArray *prhs[7], const mxArray *plhs[2])
{
  ...
  /* Marshall function outputs */
  plhs[0] = d_emlrt_marshallOut(*r_E_SC1);
  plhs[1] = d_emlrt_marshallOut(*r_E_SC2);
}
...
void Quaternion_To_Attitude_api(const mxArray *prhs[1], const mxArray *plhs[1])
{
  ...
  /* Marshall function outputs */
  plhs[0] = d_emlrt_marshallOut(*r_SC_body);
}
...
void State_Error_api(const mxArray *prhs[2], const mxArray *plhs[2])
{
  ...
  /* Marshall function inputs */
  X_ref = emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "X_ref");
  X_est = emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "X_est");

  /* Invoke the target function */
  State_Error(*X_ref, *X_est, *posError, *velError);

  /* Marshall function outputs */
  plhs[0] = d_emlrt_marshallOut(*posError);
  plhs[1] = d_emlrt_marshallOut(*velError);
}

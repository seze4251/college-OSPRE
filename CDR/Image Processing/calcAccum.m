function [accumMatrix, gradientImg] = calcAccum(varargin)
...
if(isempty(parser))
    ...
    parser.addParameter('Method','phasecode',@checkMethod);
    parser.addParameter('ObjectPolarity','bright',@checkObjectPolarity);
